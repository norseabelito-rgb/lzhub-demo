...
/**
 * PlatformIcon - Display social platform icons with optional status indicator
 */
...
/**
 * Status indicator colors (small dot overlay)
 */
 ...
 * Using simplified paths to keep bundle small
 */
